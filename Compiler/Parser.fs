...
STATES
   ...
   18 { ArithmeticSecondOrderExpression -> ArithmeticSecondOrderExpression· Minus ArithmeticFirstOrderExpression [] | ArithmeticSecondOrderExpression -> ArithmeticSecondOrderExpression· Plus ArithmeticFirstOrderExpression [] | BindingExpression -> Let Identifier Equals ArithmeticSecondOrderExpression· [$ BlockClose Break ParenClose] }
   19 { BindingExpression -> Let· Identifier Equals ArithmeticSecondOrderExpression [] }
   20 { BindingExpression -> Let Identifier· Equals ArithmeticSecondOrderExpression [] }
   21 { Expression -> ExpressionConcatenation· [$ BlockClose ParenClose] | ExpressionConcatenation -> ExpressionConcatenation· Break BindingExpression [] }
   22 { ExpressionConcatenation -> BindingExpression· [$ BlockClose Break ParenClose] }
   23 { ExpressionConcatenation -> ExpressionConcatenation Break BindingExpression· [$ BlockClose Break ParenClose] }
   24 { Program -> Expression· [$] }
   25 { TerminalEnclosedExpression -> BlockOpen Expression· BlockClose [] }
   26 { TerminalEnclosedExpression -> BlockOpen Expression BlockClose· [$ Asterisk BlockClose BlockOpen Break DoubleQuotedString Identifier Minus NumberLiteral ParenClose ParenOpen Plus Slash] }
   27 { TerminalEnclosedExpression -> DoubleQuotedString· [$ Asterisk BlockClose BlockOpen Break DoubleQuotedString Identifier Minus NumberLiteral ParenClose ParenOpen Plus Slash] }
   28 { TerminalEnclosedExpression -> Identifier· [$ Asterisk BlockClose BlockOpen Break DoubleQuotedString Identifier Minus NumberLiteral ParenClose ParenOpen Plus Slash] }
   29 { TerminalEnclosedExpression -> NumberLiteral· [$ Asterisk BlockClose BlockOpen Break DoubleQuotedString Identifier Minus NumberLiteral ParenClose ParenOpen Plus Slash] }
   30 { TerminalEnclosedExpression -> ParenOpen Expression· ParenClose [] }
   31 { TerminalEnclosedExpression -> ParenOpen Expression ParenClose· [$ Asterisk BlockClose BlockOpen Break DoubleQuotedString Identifier Minus NumberLiteral ParenClose ParenOpen Plus Slash] }
...
PRODUCTIONS
   ...
   BindingExpression -> Let Identifier Equals ArithmeticSecondOrderExpression
...
ACTION
   ...
   0     BlockOpen          shift (1)
   0     DoubleQuotedString shift (27)
   0     Identifier         shift (28)
   0     Let                shift (19)
   0     NumberLiteral      shift (29)
   0     ParenOpen          shift (2)
   1     BlockOpen          shift (1)
   1     DoubleQuotedString shift (27)
   1     Identifier         shift (28)
   1     Let                shift (19)
   1     NumberLiteral      shift (29)
   1     ParenOpen          shift (2)
   2     BlockOpen          shift (1)
   2     DoubleQuotedString shift (27)
   2     Identifier         shift (28)
   2     Let                shift (19)
   2     NumberLiteral      shift (29)
   2     ParenOpen          shift (2)
   3     BlockOpen          shift (1)
   3     DoubleQuotedString shift (27)
   3     Identifier         shift (28)
   3     Let                shift (19)
   3     NumberLiteral      shift (29)
   3     ParenOpen          shift (2)
   4     BlockOpen          shift (1)
   4     DoubleQuotedString shift (27)
   4     Identifier         shift (28)
   4     NumberLiteral      shift (29)
   4     ParenOpen          shift (2)
   5     BlockOpen          shift (1)
   5     DoubleQuotedString shift (27)
   5     Identifier         shift (28)
   5     NumberLiteral      shift (29)
   5     ParenOpen          shift (2)
   6     BlockOpen          shift (1)
   6     DoubleQuotedString shift (27)
   6     Identifier         shift (28)
   6     NumberLiteral      shift (29)
   6     ParenOpen          shift (2)
   7     BlockOpen          shift (1)
   7     DoubleQuotedString shift (27)
   7     Identifier         shift (28)
   7     NumberLiteral      shift (29)
   7     ParenOpen          shift (2)
   8     BlockOpen          shift (1)
   8     DoubleQuotedString shift (27)
   8     Identifier         shift (28)
   8     NumberLiteral      shift (29)
   8     ParenOpen          shift (2)
   ...
   9     DoubleQuotedString shift (27)
   9     Identifier         shift (28)
   9     Minus              reduce (ArithmeticFirstOrderExpression -> Application)
   9     NumberLiteral      shift (29)
   ...
   17    Plus               shift (6)
   18    $                  reduce (BindingExpression -> Let Identifier Equals ArithmeticSecondOrderExpression)
   18    BlockClose         reduce (BindingExpression -> Let Identifier Equals ArithmeticSecondOrderExpression)
   18    Break              reduce (BindingExpression -> Let Identifier Equals ArithmeticSecondOrderExpression)
   18    Minus              shift (5)
   18    ParenClose         reduce (BindingExpression -> Let Identifier Equals ArithmeticSecondOrderExpression)
   18    Plus               shift (6)
   19    Identifier         shift (20)
   20    Equals             shift (4)
   21    $                  reduce (Expression -> ExpressionConcatenation)
   21    BlockClose         reduce (Expression -> ExpressionConcatenation)
   21    Break              shift (3)
   21    ParenClose         reduce (Expression -> ExpressionConcatenation)
   22    $                  reduce (ExpressionConcatenation -> BindingExpression)
   22    BlockClose         reduce (ExpressionConcatenation -> BindingExpression)
   22    Break              reduce (ExpressionConcatenation -> BindingExpression)
   22    ParenClose         reduce (ExpressionConcatenation -> BindingExpression)
   23    $                  reduce (ExpressionConcatenation -> ExpressionConcatenation Break BindingExpression)
   23    BlockClose         reduce (ExpressionConcatenation -> ExpressionConcatenation Break BindingExpression)
   23    Break              reduce (ExpressionConcatenation -> ExpressionConcatenation Break BindingExpression)
   23    ParenClose         reduce (ExpressionConcatenation -> ExpressionConcatenation Break BindingExpression)
   24    $                  accept
   25    BlockClose         shift (26)
   26    $                  reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    Asterisk           reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    BlockClose         reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    BlockOpen          reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    Break              reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    DoubleQuotedString reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    Identifier         reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    Minus              reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    NumberLiteral      reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    ParenClose         reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    ParenOpen          reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    Plus               reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   26    Slash              reduce (TerminalEnclosedExpression -> BlockOpen Expression BlockClose)
   27    $                  reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    Asterisk           reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    BlockClose         reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    BlockOpen          reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    Break              reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    DoubleQuotedString reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    Identifier         reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    Minus              reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    NumberLiteral      reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    ParenClose         reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    ParenOpen          reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    Plus               reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   27    Slash              reduce (TerminalEnclosedExpression -> DoubleQuotedString)
   28    $                  reduce (TerminalEnclosedExpression -> Identifier)
   28    Asterisk           reduce (TerminalEnclosedExpression -> Identifier)
   28    BlockClose         reduce (TerminalEnclosedExpression -> Identifier)
   28    BlockOpen          reduce (TerminalEnclosedExpression -> Identifier)
   28    Break              reduce (TerminalEnclosedExpression -> Identifier)
   28    DoubleQuotedString reduce (TerminalEnclosedExpression -> Identifier)
   28    Identifier         reduce (TerminalEnclosedExpression -> Identifier)
   28    Minus              reduce (TerminalEnclosedExpression -> Identifier)
   28    NumberLiteral      reduce (TerminalEnclosedExpression -> Identifier)
   28    ParenClose         reduce (TerminalEnclosedExpression -> Identifier)
   28    ParenOpen          reduce (TerminalEnclosedExpression -> Identifier)
   28    Plus               reduce (TerminalEnclosedExpression -> Identifier)
   28    Slash              reduce (TerminalEnclosedExpression -> Identifier)
   29    $                  reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    Asterisk           reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    BlockClose         reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    BlockOpen          reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    Break              reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    DoubleQuotedString reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    Identifier         reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    Minus              reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    NumberLiteral      reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    ParenClose         reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    ParenOpen          reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    Plus               reduce (TerminalEnclosedExpression -> NumberLiteral)
   29    Slash              reduce (TerminalEnclosedExpression -> NumberLiteral)
   30    ParenClose         shift (31)
   31    $                  reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    Asterisk           reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    BlockClose         reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    BlockOpen          reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    Break              reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    DoubleQuotedString reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    Identifier         reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    Minus              reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    NumberLiteral      reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    ParenClose         reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    ParenOpen          reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    Plus               reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
   31    Slash              reduce (TerminalEnclosedExpression -> ParenOpen Expression ParenClose)
...
type BindingExpression =
    | Binding of Let * Identifier * Equals * ArithmeticSecondOrderExpression
    ...
    while keepGoing do
        ...
        | 18 ->
            ...
            | _ when lookaheadIsEof ->
                ...
                stateStack.Pop() |> ignore
                stateStack.Pop() |> ignore
                let arg4 = lhsStack.Pop() :?> ArithmeticSecondOrderExpression
                let arg3 = lhsStack.Pop() :?> Equals
                let arg2 = lhsStack.Pop() :?> Identifier
                let arg1 = lhsStack.Pop() :?> Let
                let reductionResult = BindingExpression.Binding (arg1, arg2, arg3, arg4)
                lhsStack.Push(reductionResult)
                let nextState =
                    match stateStack.Peek() with
                    | 0 -> 22
